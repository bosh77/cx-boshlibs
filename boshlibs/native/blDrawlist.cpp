...
// --- Stub non-Windows: la resa testo GDI non e' disponibile fuori da Win32 ---
Array<int> _CreateText(String txt, String fo, int sz){
    // 1x1 bianco opaco (BGRA), stesso layout dell'implementazione Win32
    Array<int> arr(2 + 4);
    arr[0] = 1;
    arr[1] = 1;
    arr[2] = 255; arr[3] = 255; arr[4] = 255; arr[5] = 255;
    return arr;
}
